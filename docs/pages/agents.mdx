...
Looking for pre-built trading strategies (copy-trader, early-buyer, watchlist, take-profit)? See [CLI Agent Skills](https://zoraskills.dev/guides/agent-skills) — markdown prompt files agents can follow to execute automated workflows on top of the Zora CLI.

## Resources

- [View the SDK skill file](https://docs.zora.co/skill.md)
