...
Make sure to configure these tools with the correct chain ID and RPC URL to deploy smart contracts to Zora Network Goerli and Zora Network Mainnet. See the [Network](https://docs.zora.co/zora-network/intro) section for more information.
