...
Further contract details can be found in the [Creating a Coin](/coins/contracts/creating-a-coin) section and the [Contracts Overview](/coins/contracts) section.
