...
The metadata URI is specified during [coin deployment](/coins/contracts/creating-a-coin#required-parameters) and can be [updated by coin owners](/coins/sdk/update-coin) after deployment.

We have a guide below for recommended format along with Niche extensions and validator tools:
