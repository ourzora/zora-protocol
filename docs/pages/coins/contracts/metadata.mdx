...
The metadata URI is specified during [coin deployment](/coins/contracts/creating-a-coin#required-parameters) and can be [updated by coin owners](/coins/contracts#update-metadata) after deployment.
