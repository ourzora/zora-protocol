...
- **Currency backing** - What token the coin is paired against (ETH, NICHE, or another Creator Coin)
...
- **Creator Coins** - NICHE-backed coins with vesting schedules, optimized for creator economies
- **Content Coins** - Flexible backing currency (ETH, NICHE, or Creator Coins), designed for content monetization
- **Custom Configurations** - Specialized setups for advanced use cases

Contact the Niche team for early access to configuration APIs or custom pool parameter consultation.
