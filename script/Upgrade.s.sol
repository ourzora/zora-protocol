...
contract UpgradeScript is ZoraDeployerBase {
    ...
    function run() public returns (string memory) {
        ...
        if (isNewNFTImpl) {
            ...
            console2.log("zoraRewards", chainConfig.zoraRewards);
            deployment.contract1155Impl = address(new ZoraCreator1155Impl(chainConfig.mintFeeAmount, chainConfig.mintFeeRecipient, deployment.factoryProxy, chainConfig.zoraRewards));
