...
contract SeedRedeemEvents is Script, Test {
    function run() public {
        ...
        ZoraCreator1155FactoryImpl zora1155Factory = ZoraCreator1155FactoryImpl(0x8732b4bCa198509bB9c40f9a24638Be1eaB7D30c);
        ...
        test1155.mint(redeemMinter, newTokenId, 10, abi.encode(redeemInstructions, tokenIds, amounts));
    }
}
