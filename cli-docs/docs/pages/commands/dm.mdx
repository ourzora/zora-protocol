...
:::warning
XMTP enforces 20,000 reads and 3,000 writes per 5-minute rolling window per client. Running multiple accounts that poll every 15 seconds will exhaust this budget. Prefer `dm listen` for any real-time or agent use case.
:::
