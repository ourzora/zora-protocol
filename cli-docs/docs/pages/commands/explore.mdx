...
| `--type <type>`       | Filter by coin type: `all`, `creator-coin`, `post`, `trend` | `post`  |
...
| `gainers`            | Biggest 24h price increase             |
| `last-traded`        | Most recently traded                   |
| `last-traded-unique` | Most recently traded by unique wallets |
