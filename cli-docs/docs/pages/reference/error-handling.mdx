...
| Error                  | Cause                                | Fix                                                         |
| ---------------------- | ------------------------------------ | ----------------------------------------------------------- |
| `Coin not found`       | Address or name doesn't match a coin | Verify the address or use `--type` to disambiguate          |
| `Ambiguous identifier` | Name matches multiple coin types     | Add `--type creator-coin`, `--type post`, or `--type trend` |
