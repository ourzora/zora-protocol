...
18 known contract errors are decoded, covering common scenarios like slippage violations, insufficient liquidity or funds, transfer failures, and market-state issues.
