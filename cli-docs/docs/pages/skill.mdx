...
<CopyBox>{`Set up your Zora profile → read ${skillUrl} for instructions. Install the skills using "npx @zoralabs/cli@latest skills add --all", then run the "zora-onboarding" skill to get started.`}</CopyBox>
