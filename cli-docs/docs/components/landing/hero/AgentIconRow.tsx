 ...
 * (Figma 2093:30 — no chip boxes, evenly spaced on one centerline). Each mark
 * grows a touch on hover with a spring — gated to hover-capable pointers (so a
 * touch tap never triggers it) and skipped under reduced motion.
 */
      ...
      <ul className={styles.chips}>
        {AGENT_TOOLS.map((tool) => (
          <motion.li
            ...
            whileHover={hoverable && !reduceMotion ? { scale: 1.08 } : undefined}
