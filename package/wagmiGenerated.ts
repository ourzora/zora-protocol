// Generated by @wagmi/cli@1.0.0 on 6/9/2023 at 12:26:55 PM
 ...
 * - [__View Contract on Wanchain Testnet Wan Scan Test__](https://wanscan.org/address/0x6a357139C1bcDcf0B3AB9bC447932dDdcb956703)
...
export const zoraCreator1155FactoryImplAddress = {
  ...
  999: '0x6a357139C1bcDcf0B3AB9bC447932dDdcb956703',
...
export const zoraCreator1155PreminterABI = [
  {
    type: 'error',
    inputs: [],
    name: 'INITIALIZABLE_CONTRACT_ALREADY_INITIALIZED',
  ...
  },
  {
    type: 'error',
    inputs: [
      { name: 'contractHash', internalType: 'uint256', type: 'uint256' },
      { name: 'tokenUid', internalType: 'uint256', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'contractConfig',
        internalType: 'struct ZoraCreator1155Preminter.ContractCreationConfig',
        type: 'tuple',
        components: [
          ...
          { name: 'contractName', internalType: 'string', type: 'string' },
          {
            name: 'defaultRoyaltyMintSchedule',
            internalType: 'uint32',
            type: 'uint32',
          },
          { name: 'defaultRoyaltyBPS', internalType: 'uint32', type: 'uint32' },
          {
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: 'tokenConfig',
        internalType: 'struct ZoraCreator1155Preminter.TokenCreationConfig',
        type: 'tuple',
        components: [
          ...
          { name: 'saleDuration', internalType: 'uint64', type: 'uint64' },
          { name: 'uid', internalType: 'uint256', type: 'uint256' },
        ],
      },
  ...
  },
  {
    ...
    name: 'recoverSigner',
    outputs: [{ name: 'signatory', internalType: 'address', type: 'address' }],
  },
  {
    stateMutability: 'view',
    type: 'function',
 ...
 * - [__View Contract on Wanchain Testnet Wan Scan Test__](https://wanscan.org/address/0xd81351363b7d80b06E4Ec4De7989f0f91e41A846)
...
export const zoraCreatorFixedPriceSaleStrategyAddress = {
  ...
  999: '0xd81351363b7d80b06E4Ec4De7989f0f91e41A846',
 ...
 * - [__View Contract on Wanchain Testnet Wan Scan Test__](https://wanscan.org/address/0x2c4457D38A329526063b26a2bB2C31B61553Aa98)
...
export const zoraCreatorMerkleMinterStrategyAddress = {
  ...
  999: '0x2c4457D38A329526063b26a2bB2C31B61553Aa98',
 ...
 * - [__View Contract on Wanchain Testnet Wan Scan Test__](https://wanscan.org/address/0x27817bAef1341De9Ad04097Bbba4Ea8dA32c8552)
...
export const zoraCreatorRedeemMinterFactoryAddress = {
  ...
  999: '0x27817bAef1341De9Ad04097Bbba4Ea8dA32c8552',
