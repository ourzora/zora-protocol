...
contract ZoraFactory is ERC1967Proxy {
    ...
    /// @notice Constructor for the ZoraFactory proxy
    /// @param _logic The address of the ZoraFactory implementation
    /// @dev It's very important to call the initialize function in the same transaction as the proxy deployment
    /// @dev This step is seperate due to address mining across chains but is imperative to setup correctly.
