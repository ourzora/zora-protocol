...
abstract contract LegacyNamingControl is LegacyNamingStorageV1, ILegacyNaming {
    /// @notice The name of the contract
    function name() external view returns (string memory) {
        return _getLegacyNamingStorage()._name;
    }
    ...
    function _setName(string memory _newName) internal {
        _getLegacyNamingStorage()._name = _newName;
    }
}
