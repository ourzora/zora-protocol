...
import {DeterminsticContractConfig, SparksDeterministicConfig} from "../src/Config.sol";
...
contract GenerateDeterminsticDeployment is ProxyDeployerScript {
    ...
    function mineForSparks1155Address(address sparksManagerAddress) private returns (DeterminsticContractConfig memory config) {
