...
describe("Coin Trading", () => {
  ...
  baseAnvilTest(
    ...
    async ({
      ...
      await expect(
        tradeCoin(tradeParameters, walletClient, traderAccount, publicClient),
  ...
  baseAnvilTest(
    ...
    async ({
      ...
      // await expect(
      await tradeCoin(tradeParameters2, walletClient, account, publicClient);
      // ).resolves.not.toThrow();
